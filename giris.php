...
$ikifaktorlu = ikifaktorfonksiyon();
?>
							...
							<div class="card-body">
								<div class="p-4">
									...
									<div class="text-center mb-4">
										<h5 class="">Pluton CRM</h5>
										<p class="mb-0">Lütfen Hesap Bilgilerinizi Giriniz.</p>
									</div>
									<div class="form-body">
										<form action="giris_kontrol.php" method="post" class="row g-3">
											<div class="col-12">
												<label for="kullanici_giris" class="form-label">Kullanıcı Kodu</label>
												<input type="text" class="form-control" name="kullanici_giris" id="kullanici_giris" placeholder="11111111111">
											</div>
											<div class="col-12">
											...
											<div class="col-md-6 text-end">	<a href="auth-basic-forgot-password.html">Parolamı Unuttum ?</a>
											</div>
											<div class="col-12">
												<div class="d-grid">
